...
{
    public class MultiRotationConstraintSaver : MonoBehaviour
    {
        [SerializeField] private List<string> transformPathes = new List<string>(capacity:PropertyCount);
        [SerializeField] private  MultiRotationConstraint target;
        ...
        [MenuItem("CONTEXT/MultiRotationConstraint/Transfer motion to smth", false, 612)]
        public static void TransferMotionToConstraint(MenuCommand command)
        {
            var sourceScript = command.context as MultiRotationConstraint;
            var thisScript = sourceScript.gameObject.AddComponent< MultiRotationConstraintSaver>();
