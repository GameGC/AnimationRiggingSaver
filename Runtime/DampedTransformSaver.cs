...
{
    public class DampedTransformSaver : MonoBehaviour
    {
        [SerializeField] private string[] transformPathes = new string[PropertyCount];
        [SerializeField] private  DampedTransform target;
        ...
        [MenuItem("CONTEXT/DampedTransform/Transfer motion to smth", false, 612)]
        public static void TransferMotionToConstraint(MenuCommand command)
        {
            var sourceScript = command.context as DampedTransform;
            var thisScript = sourceScript.gameObject.AddComponent< DampedTransformSaver>();
